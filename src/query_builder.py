...
class QueryBuilder:
    ...
    def select_with_joins(
        self, tables: list[str], columns: list[str], conditions: list[str] | None = None
    ) -> str:
...
def build_aggregation_query(
    table: str, group_column: str, agg_column: str, agg_function: str = "SUM"
) -> str:
...
def build_window_query(
    table: str, partition_col: str, order_col: str, window_func: str = "ROW_NUMBER"
) -> str:
